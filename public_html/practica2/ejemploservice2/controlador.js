...
.controller('controlador', ['$scope', 'obtenCombinacion'
        function ($scope, obtenCombinacion) {
            ...
            //la guardo en el service guardem la combinacio creada
...
//                if ($scope.opcio1 == $scope.password[0]) {
                ...
                if ($scope.opcio1 == obtenCombinacion.getNumeroCombinacion(1)) {
                    op2check = "igual";
                }
                if ($scope.opcio1 == obtenCombinacion.getNumeroCombinacion(2)) {
                    op3check = "igual";
                }
